...
class CoverImageView @JvmOverloads constructor(
	...
	private inner class ErrorForegroundListener : ImageRequest.Listener {
		...
		override fun onError(request: ImageRequest, result: ErrorResult) {
			...
			foreground = when {
				result.throwable.isNetworkError() && !networkState.isOnline() ->
					createErrorForeground(R.drawable.ic_offline)
				result.throwable.getShortMessage() != null ->
					createErrorForeground(R.drawable.ic_placeholder)
				else -> null
			}
		}
