...
import org.koitharu.kotatsu.core.db.DatabaseOptimizer
...
open class BaseApp : Application(), Configuration.Provider {
	...
	override fun onCreate() {
		super.onCreate()
		// Skip all initialization in the crash-handling process
		if (isCrashProcess()) {
			return
		}
		...
		// Load custom JAR plugins on startup (Usagi plugin system)
		processLifecycleScope.launch(Dispatchers.IO) {
			DynamicParserManager.loadParsersFromDirectory(
				this@BaseApp,
				PluginFileLoader.pluginsDir(this@BaseApp),
			)
		}
