...
import org.json.JSONObject
  ...
  class CustomMangaRepository(
      ...
      override suspend fun getList(
          ...
          if (_src.type == org.koitharu.kotatsu.customsource.domain.CustomSourceType.CUSTOM_TEMPLATE) {
              val _tName = _src.parserSourceName
              val _tFound = org.koitharu.kotatsu.customsource.data.ParserTemplateRepository.peekByName(_tName ?: "")
              android.util.Log.d("TsukiDebug", "CMR.getList: CUSTOM_TEMPLATE lookup name='$_tName' found=${_tFound != null} instanceReady=${org.koitharu.kotatsu.customsource.data.ParserTemplateRepository.instanceIsReady()} knownNames=${org.koitharu.kotatsu.customsource.data.ParserTemplateRepository.peekAll().map { it.name }}")
          } else {
